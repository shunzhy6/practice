...
public class RotateRight_1Test {

    RotateRight_1 rotateRight = new RotateRight_1();

    @Test
    public void rotateRight1() throws Exception {
        ListNode node = rotateRight.rotateRight(new ListNode("1,2,3,4,5"), 2);
        // 4,5,1,2,3
        Assert.assertEquals("4,5,1,2,3", node.getString());
    }
    ...
    public void rotateRight6() throws Exception {
        ...
        // 2,1
        Assert.assertEquals("2,1", node.getString());
    }
}